#!/usr/bin/env python3
"""Preprocess test data WITHOUT temporal features (matching NO_TEMPORAL training)."""
...
def main():
    ...
    parser.add_argument(
        "--train-scaler-info", type=str, default="data/processed/merged/pv_wx_simple_NO_TEMPORAL_scaler_info.json"
    )
    parser.add_argument("--out", type=str, default="data/test/processed/pv_wx_test_NO_TEMPORAL.parquet")
    args = parser.parse_args()

    print("=" * 80)
    print("TEST PREPROCESSING WITHOUT TEMPORAL FEATURES")
    print("=" * 80)
    ...
    print(f"  - NO temporal features (hour/day/weekend/holiday)")
    ...
    print(f"  - Better generalization (no time-specific overfitting)")
