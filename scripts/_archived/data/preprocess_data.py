"""Archived: Data preprocessing script for PV forecasting.

This is an exact archived copy of `scripts/data/preprocess_data.py` saved
to keep history while removing the active script from the main surface.
Use this file if you need to inspect or re-run the original preprocessing
logic. The original lived at `scripts/data/preprocess_data.py`.
"""
